...
def notice():
	...
	subprocess.check_output(["am", "start", "https://m.me/Massih.Sixty9"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/Massih7700/KEY/blob/main/key.txt').text
			if basesplit in plr:
				key = basesplit
...
█▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀█
█  Github: https://github.com/Massih7700
█  Telegram : KingMassih7700
